...
import com.vjezba.androidjetpackmovie.ui.activities.MoviesDetailsActivity
...
class NewsDetailsRecyclerViewAdapter(var articlesList: MutableList<Articles>, val moviesDetailsActivity: MoviesDetailsActivity)
    ...
    private fun bindItem(holder: ViewHolder, article: Articles) {
        ...
        moviesDetailsActivity.tvTitle?.text = article.title
    }
